...
export const categories: Category[] = [
  ...
  },
  {
    name: 'Body Care',
    href: '#',
    image: 'https://cdn.pixabay.com/photo/2016/10/06/18/43/spa-1720138_1280.jpg',
    hint: 'body lotion',
    subcategories: [
  ...
  },
  {
    name: 'Sets',
    href: '#',
    image: 'https://cdn.pixabay.com/photo/2021/01/06/06/52/cosmetics-5893325_1280.jpg',
    hint: 'skincare set',
    subcategories: [
...
export const journalPosts: JournalPost[] = [
    {
      ...
      imageUrl: 'https://cdn.pixabay.com/photo/2019/08/01/11/17/cosmetics-4377395_1280.jpg',
    ...
    },
    {
      ...
      imageUrl: 'https://cdn.pixabay.com/photo/2016/11/29/05/45/woman-1867626_1280.jpg',
    ...
    },
    {
      ...
      imageUrl: 'https://cdn.pixabay.com/photo/2016/09/01/16/09/cosmetics-1636838_1280.jpg',
...
export const orders: Order[] = [
  {
    ...
    total: 100.00,
    items: [
      { name: 'Luminous Glow Serum', image: 'https://cdn.pixabay.com/photo/2017/08/29/12/07/cosmetics-2692795_1280.jpg', quantity: 1 },
      { name: 'Radiant Cream Blush', image: 'https://cdn.pixabay.com/photo/2017/05/01/18/59/makeup-2275757_1280.jpg', quantity: 1 },
    ],
  },
  {
    id: 'ORD-12366',
    ...
    total: 58.00,
    items: [
      { name: 'Hydra-Intense Moisturizer', image: 'https://cdn.pixabay.com/photo/2017/09/20/22/50/container-2770094_1280.jpg', quantity: 1 },
    ],
  },
];
