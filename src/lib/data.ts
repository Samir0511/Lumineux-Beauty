...
export const products: Product[] = [
  {
    ...
    images: [
      { src: 'https://placehold.co/800x800.png', alt: 'Luminous Glow Serum Bottle', hint: 'serum bottle' },
      { src: 'https://placehold.co/800x800.png', alt: 'Serum texture on skin', hint: 'serum texture' },
      { src: 'https://placehold.co/800x800.png', alt: 'Model holding serum', hint: 'model skincare' },
    ],
  ...
  },
  {
    ...
    images: [
      { src: 'https://placehold.co/800x800.png', alt: 'Hydra-Intense Moisturizer Jar', hint: 'moisturizer jar' },
      { src: 'https://placehold.co/800x800.png', alt: 'Cream texture', hint: 'cream texture' },
      { src: 'https://placehold.co/800x800.png', alt: 'Moisturizer on a leaf', hint: 'natural skincare' },
    ],
  ...
  },
  {
    ...
    images: [
      { src: 'https://placehold.co/800x800.png', alt: 'Velvet Matte Foundation bottle', hint: 'foundation bottle' },
      { src: 'https://placehold.co/800x800.png', alt: 'Foundation swatches', hint: 'foundation swatches' },
      { src: 'https://placehold.co/800x800.png', alt: 'Model with flawless makeup', hint: 'makeup model' },
    ],
  ...
  },
  {
    ...
    images: [
      { src: 'https://placehold.co/800x800.png', alt: 'Radiant Cream Blush compact', hint: 'blush compact' },
      { src: 'https://placehold.co/800x800.png', alt: 'Blush swatch on arm', hint: 'blush swatch' },
      { src: 'https://placehold.co/800x800.png', alt: 'Model with rosy cheeks', hint: 'rosy cheeks' },
    ],
...
export const orders: Order[] = [
  {
    ...
    total: 100.00,
    items: [
      { name: 'Luminous Glow Serum', image: 'https://placehold.co/100x100.png', quantity: 1 },
      { name: 'Radiant Cream Blush', image: 'https://placehold.co/100x100.png', quantity: 1 },
    ],
  },
  {
    id: 'ORD-12366',
    ...
    total: 58.00,
    items: [
      { name: 'Hydra-Intense Moisturizer', image: 'https://placehold.co/100x100.png', quantity: 1 },
    ],
  },
];
